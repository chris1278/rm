...
$lang = array_merge($lang, array(
	...
	// Settings-Page
	'ACP_RM_INSTALLATIONS_INFORMATION'	=>	'<strong>Vorabinfo:</strong> Wenn du diese Erweiterung installiert und aktiviert hast, tut diese eigentlich noch gar nichts. 
											Das einzige, was du siehst, ist eine Box, die aber leer ist. <br> <br>Du musst diese Box erstmal mit einem Inhalt füllen. Dazu gehst du wie folgt vor:<br><br> 
											<br>
											Gehe auf die Seite <a href="https://www.revolvermaps.com/" target="_blank"><mark>Revolvermaps.com</mark></a> und suche dir dort ein Widget aus was du gerne haben möchtest. Du kannst zwischen verschiedenen Optionen bzw. Varianten  wählen. 
											Wenn du dir dort ein Widget erstellst, bekommst du am Ende einen Script Code denn du in deine Homepage einbinden kannst. Das Widget ist nicht nur für Foren geeignet, sondern man kann dieses auch auf einer ganz normalen HTML Homepage einbinden.
											Diesen Script Code brauchst du, damit du in deinem Forum dieses Widget einbinden kannst.<br><br>
	...
	'RM_WIDGET_EXPLAIN'					=>	'Hier gib bitte dein Script ein welches du dir vorher bei <a href="https://www.revolvermaps.com/" target="_blank"><mark>Revolvermaps.com</mark></a> erstellen lassen musst. <br><br>Weitere Info Siehe Obere Box.',
